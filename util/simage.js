...
function result_img(head, name, backimgurl, code, callback) {
    if (name && head) {
        ...
        gm().in('-page','+0+0').in(backimgurl)
          ...
          .in('-page','+108+1236').in(__dirname+'/qr/'+code)
...
function getUserImg(name, headimgurl, backimgurl, code,callback) {
                ...
                .write(output, function () {
                    gm(size, size, 'none')
                        ...
                        .write(output, function (err) {
                            ...
                            result_img(head, name, backimgurl,code,callback)
                        });
                });
        })
    } else {
        result_img('', name, backimgurl,code,callback)
    }
}
